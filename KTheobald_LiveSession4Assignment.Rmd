...
## Change Columns to from Factors to Numeric Values. 

PlayerStats$FGM<- as.numeric(PlayerStats$FGM)
PlayerStats$FGA<- as.numeric(PlayerStats$FGA)
PlayerStats$'FG%'<- as.numeric(PlayerStats$'FG%')
PlayerStats$'3PM'<- as.numeric(PlayerStats$'3PM')
PlayerStats$'3PA'<- as.numeric(PlayerStats$'3PA')
PlayerStats$'3P%'<- as.numeric(PlayerStats$'3P%')
PlayerStats$FTM<- as.numeric(PlayerStats$FTM)
PlayerStats$FTA<- as.numeric(PlayerStats$FTA)
PlayerStats$'FT%'<- as.numeric(PlayerStats$'FT%')
PlayerStats$'2PM'<- as.numeric(PlayerStats$'2PM')
PlayerStats$'2PA'<- as.numeric(PlayerStats$'2PA')
PlayerStats$'2P%'<- as.numeric(PlayerStats$'2P%')
PlayerStats$'SC-EFF'<- as.numeric(PlayerStats$'SC-EFF')
PlayerStats$'SH.EFF'<- as.numeric(PlayerStats$'SH.EFF')
PlayerStats
```
